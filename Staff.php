...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->
    <link href="img/شعار.jpg" rel="icon" />
  ...
  <body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
      ...
      >
        ...
        >
        <img src="img/CCIS.jpg" alt="Logo" width="80" height="80" class="d-inline-block align-text-top">
        ...
        >
          <div class="navbar-nav font-weight-bold mx-auto py-0">
            ...
            <a href="class.html" class="nav-item nav-link">Staff member login</a>
            <a href="team.html" class="nav-item nav-link active">Student / Visitor</a>
            <a href="gallery.html" class="nav-item nav-link">Help</a>
            ...
            <div class="contact-form">
              ...
              <form name="sentMessage" id="contactForm" novalidate="novalidate">
                <div class="control-group">
                  <input type="text" class="form-control" id="name" placeholder="Professor name" data-validation-opening-message=""
                  />
    ...
    >
      <div class="row pt-5">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
          ...
          <div class="d-flex flex-column justify-content-start">
            ...
            >
            <a class="text-white mb-2" href="#"
              ><i class="fa fa-angle-right mr-2"></i>Staff member login</a
            >
            <a class="text-white mb-2" href="#"
      ...
      >
        <p class="m-0 text-center text-white">
          &copy;
          <a class="text-primary font-weight-bold" href="#">CCIS</a>.
          All Rights Reserved.
